    ...
    <div class="card">
        ...
        <div class="card-body">
            <form method="POST" action="{{ route('login') }}">
                ...
                <div class="external_logings">
                    <div class="logocontainer">
                        <a href="{{ route('google.login') }}" class="login-sites">
